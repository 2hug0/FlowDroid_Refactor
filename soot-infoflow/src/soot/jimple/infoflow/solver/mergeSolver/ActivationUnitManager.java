...
public class ActivationUnitManager {
	...
	protected final Symbol inactiveSymbol;
	...
	public Abstraction symbolize(Unit callSite, SootMethod callee, Abstraction retSiteAbs,
			Abstraction exitAbs) {
		final ConcolicUnit activationUnit = retSiteAbs.getConcolicActivationUnit();
		...
		return retSiteAbs.replaceActivationUnit(activationUnit);
	}
	...
	public Abstraction attachActivationUnit(Abstraction callSiteAbs, Abstraction retSiteAbs) {
